...
public class AssertionExTests {
    ...
    public void functionOfChecBox() throws InterruptedException {
        ...
        JavascriptExecutor js = (JavascriptExecutor) driver; //метод проскрулить страницу вверх по //
        js.executeScript("scrollBy(0,200)");//координатам x,y//
    ...
    public void countOfIngridients() {
        ...
        assertTrue(sparza.size() == 4, "Кол-во ингридиентов не совпадает с ожиданием");//количество позиций ингридиентов для List sparza//
        ...
        for (int i = 0; i < sparza.size(); i++) {
            assertEquals(sparza.get(i).getText(), labelsSparza[i]);//сравнение массива текста и саого текста//
        }
